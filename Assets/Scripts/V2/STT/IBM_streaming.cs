...
public class IBM_streaming : MonoBehaviour
{
    ...
    private string _esEsModel = "es-ES_BroadbandModel";
    //private string _enEnModel = "en-US_BroadbandModel";
    ...
    public bool Active
    {
        ...
        set
        {
            ...
            {
                _service.RecognizeModel = (string.IsNullOrEmpty(_recognizeModel) ? _esEsModel : _recognizeModel);
    ...
    //Resumen:
    //      setSTTHandler(STT_Handler sttHandler) does as it says, it
    //      just sets the currentSTTHandler
    ...
    //Resumen:
    //      OnRecognize(SpeechRecognitionEvent result) is automatically
    //      called everytime a voice has been recognized, and the
    //      recognition comes in the result, which is then send to the 
    //      currentSTTHandler in case there is one assigned.
